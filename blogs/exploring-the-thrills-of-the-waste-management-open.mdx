...
with a steadfast commitment to environmental sustainability. Waste Management, the
tournament's title sponsor, is at the forefront of this green revolution which has
implemented various initiatives to minimize the event's ecological footprint.
<br />
