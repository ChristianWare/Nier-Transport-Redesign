...
toc:
  [
    { id: 01, heading: "understanding the basics" },
    { id: 02, heading: "the swing technique" },
    { id: 03, heading: "navigating the course" },
    { id: 04, heading: "scoring and course etiquette" },
    { id: 04, heading: "improving your skills" },
    { id: 04, heading: "summary" },
  ]
---
